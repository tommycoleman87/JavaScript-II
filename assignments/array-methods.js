...
// Problem 1
let topDonors = runners.filter(runner => runner.donation > 200);
// Problem 2
let alphabeticalNames = runners.map(runner => runner.first_name + ' ' + runner.last_name).sort();
console.log(alphabeticalNames)

// Problem 3
let averageDonation = runners.reduce((total, runner) => {
    return  total += runner.donation;
  }, 0) / runners.length;
